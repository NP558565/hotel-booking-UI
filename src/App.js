...
class App extends Component {
  ...
  render() {
    return (
      <div className="App">
        {/*In the App.js file, pass a reference to the toggleFilter method from the App 
component where the state is managed to the Filters component. 
It’ll look like this: toggleFilter={this.toggleFilter}*/}
